    ...
    return (
        <div className="home">
            <div className="welcome">
                ...
                <br/>
                <br/>
                {currentUser.is_agent ? <button className="button" onClick={() => history.push('/trips/new')}>Get Started 🌴</button> : <button className="button" onClick={() => history.push('/inspiration')}>Get Started 🌴</button>}
                <br/><br/>
