    ...
    return (
        <div className="home">
            <div className="welcome">
                ...
                Utilize this SPA to book pre-packaged vacations with our experienced agents, or build out your own dream trip.
                <br/>
                ...
                {/* make this button conditional if you are an agent or not - agents push to trips/new */}
                <br/><br/>
